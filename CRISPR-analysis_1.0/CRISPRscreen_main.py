...
os.system('python CRISPRscreen_gene.py %s %s %s %s %s %s %s %s %s %s %s %s 2>>error.log'%(geneDic,geneLst,sgRNALst,stressed_conditionLst,gene_sgRNA_position,control_setting,hit_gene_calling,FDR_threshold,prefix,sgRNAperQuasiGene,QuasiGene_number,min_sgRNAnumber))
