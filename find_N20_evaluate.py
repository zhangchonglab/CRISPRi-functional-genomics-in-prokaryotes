...
if sgRNA_existence_flag:
    ...
    for ID in sgRNA_ID_collection:
        ...
        judgement=sgRNA_judge(Candidate_N20mismatchDic[sgRNA_ID],off_threshold) if not multiple else sgRNA_judge(Candidate_N20mismatchDic[sgRNA_ID],copy_number,off_threshold)
