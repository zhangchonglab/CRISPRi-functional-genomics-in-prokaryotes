...
spacer_length=int(sys.argv[3])
GCcontentMin=int(sys.argv[4])
GCcontentMax=int(sys.argv[5])
prefix=sys.argv[6]
...
os.system('cat /dev/null > %s_N20_NC_passed.fasta'%(prefix))
number_record=0
g=open('%s_N20_NC_passed.fasta'%(prefix),'r+')
